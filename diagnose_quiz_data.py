...
# Files used by the quiz
PAINTINGS_FILE = 'data/paintings_appended.json'  # Now use the latest appended data
BIOS_FILE = 'data/artist_bios.json'
REPORT_FILE = 'diagnostics_report.md'
...
def main():
    ...
    lines = []
    lines.append(f'# Art Quiz Data Diagnostics\n')
